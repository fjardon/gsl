"*===========================================================================*
"*                                                                           *
"*  in.vim - vimscript to activate project's build script for edited file    *
"*                                                                           *
...
set makeprg=${GSL_PROJECT}/build-aux/build
let g:syntastic_c_include_dirs = ['${GSL_PROJECT}/src', '${GSL_PROJECT}/lib']
